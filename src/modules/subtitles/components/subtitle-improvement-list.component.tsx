...
export const SubtitleImprovementList: React.FC<SubtitleImprovementListProps> = ({ block, video, subtitle }) => {
  ...
  const subtitleImprovementsList = useSelector((state: RootState) => state.subtitleImprovement
